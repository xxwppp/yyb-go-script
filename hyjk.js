...
// 本地运行版（脱敏前等价备份）：密钥已内联，无需 hyjk.config.js，请勿提交到公开仓库
const wxAppId = "wx776afedbfae3a228";
...
class Task {
    constructor(env) {
        ...
        this.headers = {
            ...
            "apptype": "1",
            "user-agent": `Mozilla/5.0 (iPhone; CPU iPhone OS 16_7_15 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 MicroMessenger/8.0.70(0x18004630) NetType/WIFI Language/zh_CN miniProgram/${wxAppId}`,
            "appversion": "3.1.7",
    ...
    async getFruitInfo() {
        ...
        if (result.code == 0 && result.result) {
            ...
            if (!this.treeId) {
                $.log(`[账号${this.index}] 未种植果树(treeId=0)，跳过浇水`)
            } else {
    ...
    encrypt(body) {
        ...
        // 来源：https://www.heyejk.com/game（旧逆向 dead code 已移除，活跃实现见上方 getSign/entryData/decrypt）
    }
